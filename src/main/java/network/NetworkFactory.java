...
//        vertex.put("Device 1", EquipmentFactory.getCommonDevice());
    ...
    public static NetworkInterface demoWithRandomNetwork() {

        Graph<EquipmentInterface, DefaultEdge> graph = new SimpleDirectedGraph<>(DefaultEdge.class);

        Map<String, EquipmentInterface> vertex = new HashMap<>();

        EquipmentInterface F1 = EquipmentFactory.getRandomFog();
        EquipmentInterface F2 = EquipmentFactory.getRandomFog();
        EquipmentInterface F3 = EquipmentFactory.getRandomFog();
        EquipmentInterface F4 = EquipmentFactory.getRandomFog();
        EquipmentInterface F5 = EquipmentFactory.getRandomFog();
        EquipmentInterface F6 = EquipmentFactory.getRandomFog();
        ...
        NetworkInterface network = new CommonNetwork(graph);
        network.setNetworkName("demo network with random");
        return network;
    }
